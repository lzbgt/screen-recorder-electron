...
const cmdRecord = `-y -f gdigrab -draw_mouse 1 -framerate 15 -r 15 -i desktop -f dshow -i audio="<audiodev>" -af "highpass=f=200, lowpass=f=3000" -c:v libx264 -b:v 1M -crf 35 -preset medium -pix_fmt yuv420p -c:a libvorbis -ac 2 -b:a 48k -fs 100M -movflags +faststart <filename>`;
