...
const cmdRecord = `-y -rtbufsize 100M -f gdigrab -draw_mouse 1 -framerate 25 -r 25 -i desktop -f dshow -i audio="<audiodev>" -af "highpass=f=200, lowpass=f=3000" -c:v libx264 -b:v 4M -preset ultrafast -tune zerolatency -pix_fmt yuv420p -c:a libvorbis -qscale:a 3 -ac 2 -b:a 3M -fs 50M -movflags +faststart <filename>`;
